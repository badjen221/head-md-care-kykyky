...
> An interactive, wordless story about three roommates learning to share a home — and to care for one another.
...
| | |
|---|---|
| **Type** | Interactive, wordless narrative experience |
| **Audience** | Children aged 4–8 |
| **Platform** | Touchscreen / tablet |
| **Interaction** | A single repeated gesture — tapping |
| **Theme** | Care, cohabitation, shared responsibility |
| **Characters** | Rokhy (baby) · Lucky (dog) · Cheeky (cat) |
| **Context** | Developed for an interactive exhibition at the Bibliothèque municipale de Genève |
| **Course** | Master Media Design 1 — Care Workshop, HEAD Genève |
| **Authors** | Maria Sarafi · Rokhy Niang · Zainab Ouriachi |
...
The experience was developed within the **Care Workshop** of the Master Media Design programme at HEAD Genève, with the goal of being shown as an interactive installation at the **Bibliothèque municipale de Genève**.
...
As the experience progresses, Cheeky's arrival introduces disruption and new relationship dynamics, and the same care-based gesture gradually transforms moments of separation into moments of cooperation. By the end, all three characters respond together, forming the Kykyky team and demonstrating how a simple act of care can strengthen relationships within a shared living space.
...
### Techniques
The production combined several techniques to bring the world to life: **3D modelling** of characters, furniture, and the apartment; **rigging** of a 3D animal model; **motion capture** to drive and smooth the animation; and dedicated **sound recording** sessions (the second carried out in a quiet box) to refine the audio experience.
